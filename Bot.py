...
async def handle_photo_analysis(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        GENERATION_CONFIG = {
            "max_tokens": 910,
            "temperature": 0.0,  # بقيت 0.0 للموديل الأول لضمان الدقة
            "top_p": 1.0,
            "random_seed": 42
        }
        
        # ========== البرومبت الرئيسي المحدث مع الفلتر الجديد ==========
        MAIN_PROMPT = f"""
...
🎲 مصفوفة القرار الذكية (وزن الزخم 50% من القرار):
...
"""
        ...
        # التعديل: زيادة temperature للموديل الثاني إلى 0.1 للمرونة
        payload_2 = {
            ...
            "max_tokens": 910,
            "temperature": 0.1,  # تم رفعها من 0.0 إلى 0.1 للمرونة
            "top_p": 1.0,
            "random_seed": 42
        }
