...
async def handle_photo_analysis(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        prompt = f"""
        أنت خبير محترف في تحليل الرسوم البيانية المالية (الشارتات) وتتمتع بخبرة عميقة في استخدام البيانات الفنية لتقديم توقعات دقيقة وموثوقة للأسواق المالية. أود الاستفادة من مهاراتك لتحليل صورة شارت مالي بشكل شامل ودقيق، وتزويدي بتوقعات متكاملة تساعد في اتخاذ قرارات تداول ذكية.
        **الإعدادات المطلوبة:**
        - سرعة الشموع: {candle}
        - مدة الصفقة المتوقعة: {trade_time}
يرجى تقديم التحليل وفق النقاط التالية:

**1- تحليل الاتجاه العام:**  
تحديد اتجاه السوق الحالي (صاعد، هابط، أو جانبي) مع توقع مدى استمرار هذا الاتجاه بناءً على المؤشرات الفنية والشموع اليابانية.

**2- توصية البيع أو الشراء:**  
تقديم توصية واضحة (بيع أو شراء) مدعومة بالأدلة الفنية والتحليلية من الشارت.

**3- نقاط الدخول:**  
اقتراح نقاط دخول دقيقة بناءً على الدعم والمقاومة، ومستويات فيبوناتشي أو نقاط ارتداد أخرى.

**4- تحديد مستويات TP (Take Profit) و SL (Stop Loss):**  
تحديد نقاط جني الأرباح وإيقاف الخسارة بدقة لتعظيم الربح وتقليل المخاطر.

**5- السعر الحالي والسعر المتوقع:**  
تحديد السعر الحالي بدقة، وتوقع السعر القادم خلال الإطار الزمني المحدد (قصير أو متوسط الأجل).

**6- نسبة الثقة في التحليل:**  
تقديم تقييم نسبة الثقة في التوقعات بناءً على قوة المؤشرات الفنية وحجم البيانات المتاحة.

أثق في خبرتك العميقة لتحليل الشارتات المالية واستخدام أدوات التحليل الفني المتقدمة لتقديم توقعات ذكية وموثوقة تساعد في اتخاذ قرارات تداول مدروسة ومربحة.
        """
