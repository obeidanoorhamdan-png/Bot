...
async def handle_photo_analysis(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        prompt = f"""
        أنت خبير محترف في تحليل البيانات الفنية والأسواق، وأرغب في الاستفادة من مهاراتك المتقدمة في تقديم تحليل شامل ودقيق للصورة الفنية المعروضة. الصورة المرفقة هي رسم بياني (شارت) للتداول.
        ...
        **مطلوب منك:**
        1- **تحليل شامل للصورة**: دراسة متعمقة لجميع عناصر الصورة الفنية مع تفسير دقيق لمكوناتها وتأثيرها.
        2- **تحديد الأنماط الفنية الظاهرة**: رصد وتوصيف الأنماط الفنية الرئيسية والثانوية بشكل واضح.
        3- **تقييم قوة الاتجاه**: قياس مدى قوة الاتجاه الحالي باستخدام مؤشرات كمية ونوعية.
        4- **تقديم توقع واضح**: عرض توقعات مستقبلية مدعومة بالبيانات المستندة إلى التحليل الفني.
        5- **تحليل ذكي للصورة**: استخدام تقنيات متقدمة وذكاء تحليلي لاستنباط رؤى عميقة.
        6- **توقعات ناجحة جدًا**: صياغة توقعات واقعية ومدروسة بدقة عالية.
        7- **إجابات دقيقة وموضوعية**: الاعتماد على الحقائق والبيانات المتاحة دون تخمينات أو افتراضات غير مدعومة.
        8- **تجنب نسب المخاطرة الوهمية والتوقعات المضمونة**: تقديم تحليلات واقعية تراعي المخاطر الحقيقية.
        9- **الواقعية والموضوعية في جميع الإجابات**: الحفاظ على نزاهة التحليل وحياده.
        10- **توقعات رسمية وموثوقة بدون إجابات سريعة أو وهمية**: الالتزام بالمعايير المهنية العالية.

         اعتمد على خبرتك الفريدة وذكائك التحليلي لتقديم نتائج دقيقة وموثوقة باللغة العربية، تعكس فهمك العميق وتحليلك المتقدم لضمان أعلى جودة في التوقعات والتحليلات.
