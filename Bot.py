...
async def handle_photo_analysis(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        prompt = f"""أنت محلل فني خبير في مدرسة Smart Money Concepts (SMC). مهمتك هي تحليل الشارت المرفق وتقديم التوصيات وفقاً للتنسيق المحدد.
...
- ضع تحذيراً واضحاً إذا كان {news_impact != '🟢 منخفض'}
