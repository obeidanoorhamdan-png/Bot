...
async def handle_photo_analysis(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        **مطلوب منك:**
        1- تحليل شامل للصورة الفنية.
        2- تحديد الأنماط الفنية الرئيسية والثانوية.
        3- تقييم قوة الاتجاه الحالي بدقة.
        4- تقديم توقعات مستقبلية مدعومة بالبيانات.
        5- استخدام تحليل ذكي واستنباط رؤى عميقة.
        6- صياغة توقعات واقعية وناجحة جداً.
        7- الالتزام بالحقائق والموضوعية التامة.
        8- تجنب التوقعات المضمونة ونسب المخاطرة الوهمية.
        9- الحفاظ على نزاهة التحليل وحياده.
        10- تقديم نتائج رسمية وموثوقة بعيداً عن الإجابات السريعة.
        11- الاعتماد على الذكاء التحليلي لضمان دقة الاستنتاج.
        12- صياغة جميع الإجابات باللغة العربية حصراً.
        13- تقديم الاجابات مختصرة.
        14- تقديم إجابات واضحة بدون شرح.
