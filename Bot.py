...
{analyses.get('pixtral_large', 'غير متوفر')}

**التحليل الثاني (Mistral Pixtral):**
{analyses.get('mistral_pixtral', 'غير متوفر')}

**مهمتك:**
1. **دمج الرؤى:** ادمج أفضل الأفكار من التحليلين
...
**التنسيق النهائي المطلوب للخطوة التالية:**

🎯 **التحليل المدمج الأولي:**
• **ملخص الرؤى المشتركة:** [تلخيص النقاط المشتركة بين التحليلين]
• **النقاط المتفق عليها:** [النقاط التي اتفق عليها الموديلان]
• **النقاط المختلف عليها:** [النقاط التي اختلف عليها الموديلان وكيف تم حلها]
• **التوصية المبدئية:** [التوصية المتفق عليها أو الأكثر منطقية]

📊 **الجاهزية للتدقيق النهائي:** [مستوى الجودة الأولية]
...
**البيانات المتوفرة:**
1. **التحليل المدمج من الموديلين السابقين:**
{merged_result}

2. **الشارت الأصلي:** [مرفق مع الرسالة]

**مهمتك الحاسمة:**
1. **القراءة الدقيقة:** قراءة جميع الأرقام والمستويات من الشارت بدقة متناهية
2. **التدقيق الرقمي:** التحقق من صحة جميع الأرقام (السعر الحالي، الدخول، SL، TP)
3. **التصحيح البصري:** تصحيح أي أخطاء في قراءة الشارت من التحليل السابق
4. **التحسين النهائي:** تحسين الصياغة والوضوح والاحترافية
5. **الإضافة القيمة:** إضافة أي ملاحظات تقنية إضافية يمكن رؤيتها من الشارت

**الأولويات:**
1. **الدقة أولاً:** الأرقام الدقيقة من الشارت هي الأهم
2. **الواقعية:** التوصيات يجب أن تكون قابلة للتطبيق واقعياً
3. **الوضوح:** التقرير النهائي يجب أن يكون واضحاً وسهل المتابعة
4. **الشمولية:** تغطية جميع الجوانب الفنية المهمة

**التنسيق النهائي المطلوب (الالتزام الحرفي):**

📊 **التحليل الفني المتقدم (النهائي):**
• **البصمة الزمنية:** {kill_zone_status}
• **حالة الهيكل:** (صاعد/هابط) + (مرحلة وايكوف الحالية) + (توافق 4/4 إطارات: نعم/لا)
• **خريطة السيولة:** (أقرب فخ سيولة Inducement + مناطق السيولة المستهدفة)
• **الفجوات السعرية:** (المناطق التي سيعود السعر لتغطيتها)
