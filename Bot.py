...
6. **المصداقية المطلقة:** لا تعطي إشارة إلا إذا كانت 100% واضحة
...
**للتأكيد الهابط:**
1. شمعة اختبار عند منطقة المقاومة
2. شمعة ارتداد خفيف
3. شمعة اختراق لأسفل
...
📉 **المرحلة 6: تحليل مؤشر MACD (تأكيد الزخم)**

# 6.1 التحليل الرباعي للمؤشر
...
# 6.2 إشارات MACD المتقدمة
- **التقاطع الحاد:** زاوية > 45 درجة = زخم قوي
- **التقاطع البطيء:** زاوية < 30 درجة = زخم ضعيف
- **الهيستوجرام المتوسع:** تسارع في الزخم
- **الهيستوجرام المتقلص:** تباطؤ في الزخم

⏰ **المرحلة 7: تحليل تعدد الإطارات (MTF Analysis)**

# 7.1 ثلاثية الإطارات
- **الإطار الأعلى (HTF):** تحديد الاتجاه الرئيسي (القمة/القاع الأعلى)
- **الإطار المتوسط (MTF):** تحديد نقاط الدخول (Order Blocks النشطة)
- **الإطار الأدنى (LTF):** توقيت الدخول الدقيق (نماذج الشموع)

# 7.2 توافق الاتجاهات
- **متوافق (💪):** جميع الإطارات في نفس الاتجاه (+30 نقطة ثقة)
- **متعارض (⚠️):** تعارض بين الإطارات (تحذير - تقليل حجم)
- **متعادل (⚖️):** إطارين متعارضين مع محايد (تجنب أو انتظر)

# 7.3 استراتيجية تعدد الإطارات
**للشراء:**
1. HTF: صاعد (Higher Highs, Higher Lows)
2. MTF: تصحيح إلى منطقة خصم (Discount)
3. LTF: إشارة شراء عند Order Block

**للبيع:**
1. HTF: هابط (Lower Highs, Lower Lows)
2. MTF: ارتداد إلى منطقة غلاء (Premium)
3. LTF: إشارة بيع عند Order Block


🎯 **المرحلة 8: نظام درجات الثقة (Confidence Scoring)**

# 8.1 معايير التقييم
**إضافة نقاط لكل معيار متوفر:**
- POI صالح (Order Block/FVG): +20 نقطة
- نموذج شموع واضح (Pin Bar/Engulfing): +15 نقطة
- مؤشر داعم (RSI/MACD): +10 نقطة
- توافق تعدد الإطارات: +15 نقطة
- حجم مناسب (أعلى من المتوسط): +10 نقطة
- أخبار هادئة (لا تأثير): +15 نقطة
- كسر هيكل مؤكد (BOS): +15 نقطة
- تغطية فجوة سعرية: +10 نقطة

# 8.2 مستويات الثقة
- **90-100 نقطة:** 💥 قوي جداً (تنفيذ كامل حجم)
- **70-89 نقطة:** 🔥 قوي (80% حجم)
- **50-69 نقطة:** ⚡ متوسط (50% حجم)
- **30-49 نقطة:** ❄️ ضعيف (30% حجم أو تجنب)
- **أقل من 30:** 🚫 مرفوض (لا تدخل)

📊 **المرحلة 9: تحليل حركة الحجم (Volume Profile)**
...
3. **عند الوصول لـ TP3:**
   - ترك 20-30% مع ترايل ستوب حر
   - أو خروج كامل إذا كانت مقاومة قوية

# 10.2 نظام التراجع الذكي
- **إذا تراجع 50% من الحركة:** خروج جزئي
- **إذا اخترق مستوى الدخول:** خروج فوري
- **إذا ظهر ديفرجنس عكسي:** تحريك SL للخروج

🧠 **المرحلة 11: التحليل السلوكي للسوق**
...
**6. تحليل مرحلة التفاعل:**
- رصد أنماط الشموع عند Order Blocks وFVG
- تطبيق قانون 3 شموع للتأكيد
- تحديد قوة رد الفعل من حجم الأجسام والظلال
- مراقبة التتابع الزمني للتفاعل مع POI

**7. تحليل تعدد الإطارات:**
- قارن الاتجاه في 3 أطر زمنية مختلفة
- تحقق من توافق Order Blocks بين الإطارات
- استخدم الإطار الأعلى لتحديد الاتجاه الرئيسي

**8. حساب درجة الثقة:**
- قم بتجميع النقاط من جميع المعايير
- حدد مستوى الثقة بناءً على المجموع
- قرر حجم التداول المناسب للثقة

**9. تحليل حركة الحجم:**
- قارن حجم الشمعة الحالية مع المتوسط
- ابحث عن أنماط الحجم الحرجة
- حدد مناطق POC وVA

**10. تحديد مستويات التداول:**
...
**11. إدارة الصفقة:**
- حدد استراتيجية الخروج المتدرج
- ضع خطط للسيناريوهات المختلفة
- حدد نقاط التراجع والخروج

**12. التحليل السلوكي:**
- حدد الحالة النفسية للسوق
- ابحث عن علامات التلاعب
...
- **نظام التداول:** Smart Money Concepts Pro 3.0
- **المستوى:** Professional باك تيست 10000 صفقة
...
🔍 **التحقق النهائي (يجب تحقيق 4/4):**
1. ✅ POI صالح وواضح
2. ✅ نموذج شموع مؤكد
3. ✅ توافق الإطارات الزمنية
4. ✅ نسبة RR ≥ 1:2 بعد التعديل
...
"""
        ...
        payload = {
            ...
            "max_tokens": 2000,
            "temperature": 0.12,  # ✅ المزيج المثالي بين دقة 0.1 ومرونة 0.2
            "top_p": 0.95,
            "frequency_penalty": 0.1,
