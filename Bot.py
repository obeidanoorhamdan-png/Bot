...
🔰 **القواعد الأساسية**
• المدرسة: SMC + ICT مع دعم كلاسيكي  
...
• أولوية الزخم: شموع ابتلاعية >80% + إغلاق فوق القمة السابقة  
...
- ربط الفلاتر بالقرار النهائي: أي فلتر مفعل يمنع القرار حتى تحقق شرطه  
...
• التحقق الرقمي: استخراج الأسعار ومطابقتها مع الشارت  
...
2.2 استخراج الإحداثيات: أعلى/أدنى سعر، نسبة الحركة، دقة مطلقة  
...
• توافق: 4/4=+40، 3/4=+30، 2/4=تقليل حجم، 1/4=منع الدخول  
...
📊 **نتيجة التدقيق الفني:**
• **مقارنة مع التحليل السابق:** [✅ تطابق كامل / ⚡ تحسين طفيف / ❌ اختلاف كبير]
• **درجة التشابه:** [0–100]% (بناءً على القرار الفني والأهداف)

🎯 **التوصية النهائية المعتمدة:**
• **السعر الحالي:** [السعر الدقيق من الصورة]
• **القرار الفني:** (شراء 🟢 / بيع 🔴 / احتفاظ 🟡)
• **قوة الإشارة:** (عالية جدا 💥 / عالية 🔥 / متوسطة ⚡ / ضعيفة ❄️)
• **سبب القرار:** [سبب واضح ومختصر من الصورة]
• **مستوى الثقة:** [0-100]٪ (بناءً على وضوح الإشارة)

⚠️ **ملاحظات التدقيق:**
• [أي ملاحظات مهمة للتحليل الأولي]
• [تحسينات مقترحة إذا وجدت]
...
"""
        ...
        full_result = (
            ...
            f"━━━━━━━━━━━━━━━━━━━━━━\n"
            f"📊 **التحليل الفني الأولي:**\n"
            f"{initial_analysis}\n\n"
            f"🔍 **نتيجة التدقيق النهائي:**\n"
            f"{audit_result}\n\n"
