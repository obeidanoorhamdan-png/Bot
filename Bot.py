...
- **نقطة الدخول الذهبية (POI)**: [تحديد السعر بناءً على OB أو Breaker]
- **الأهداف (TPs)**: 
           - 🎯 **TP1**: [سحب سيولة أولية - حجز ربح]
           - 🎯 **TP2**: [منطقة عرض/طلب رئيسية - Major PD Array]
           - 🎯 **TP3**: [الامتداد الهيكلي الأقصى أو سيولة خارجية]
 - **وقف الخسارة (SL)**: [خلف منطقة الحماية المؤسسية - Invalidated Level]
- **مستوى الثقة**: [% مع ذكر عدد التأكيدات]
- **المدة المتوقعة 🕧**: [عدد الشموع على فريم الدخول]
- **الوقت الفعلي للمس الهدف**: [توقع الساعة والدقيقة حسب توقيت القدس]
- **أقصى مدة صلاحية**: [توقيت انتهاء صلاحية المنطقة زمنياً]
