...
"""
        ...
        prompt_audit = f"""🛡️ **التقرير النهائي المعتمد – أنت محلل فني خبير SMC + ICT (أسهم، صناديق، سلع، كريبتو، فوركس). مهمتك تحليل الشارت المرفق وإصدار توصيات دقيقة. (SMC Pro Audit Report)**
