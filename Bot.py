...
• نقطة الدخول: [السعر الدقيق بناءً على OB ]
• * شرط اغلاق الحالية :* ( شمعة حمراء 🔴/ خضراء 🟢) [ نقطة الإغلاق ] 
...
"""
        ...
        AUDIT_PROMPT = f"""
أنت مدقق فني خبير SMC + ICT. مهمتك تدقيق التحليل التالي الذي تم إجراؤه على الشارت المرفق باستخدام جميع الأساليب (سكالبينغ، إنتراداي، سوينغ، OTC) :
