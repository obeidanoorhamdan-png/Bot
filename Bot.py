...
3. حاجز السيولة: لا دخول عكس FVG غير مغطاة
4. أرقام مستديرة: منع دخول ±5 نقاط بدون CHoCh
...
• LAST MINUTE RULE: تجاهل انعكاسات الدقيقة 29/59

🧠 Decision Matrix (1-10 لكل بند)
• قوة الزخم (ضرب ×2 إذا 9-10)، الهيكل، حجم التداول، توافق الإطارات، جودة الشموع، قوة S/R، توقيت، ظروف خارجية
• النتيجة النهائية = (المجموع/90 ×100)٪
