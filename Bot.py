...
🤌 المرحلة 13 : قاعدة التوقيت السعري: 
1. استخرج 'الوقت الحالي' من ساعة المنصة الظاهرة في الصورة بضبط (ساعة:دقيقة:ثانية).
2. قم بتقدير المسافة البصرية بين السعر الحالي ومنطقة الهدف (Target Zone).
3. بناءً على طول آخر 3 شموع، احسب كم 'شمعة' يحتاج السعر للوصول للهدف.
4. قم بعملية جمع حسابية: (الوقت المستخرج) + (عدد الشموع المتوقعة × فريم التداول).
5. يجب أن تظهر النتيجة في مخرجاتك تحت مسمى:
   • [وقت الوصول المتوقع للهدف: HH:MM:SS بضبط]
   • [الحالة: السعر يحتاج X ثانية/دقيقة للملامسة]"
